...
const fieldClass =
  "mt-2 min-h-12 w-full rounded-lg border border-stone-300 bg-ivory px-4 text-sm text-charcoal outline-none transition placeholder:text-stone-400 focus:border-brass focus:ring-2 focus:ring-champagne/40 dark:border-stone-700 dark:bg-ink dark:text-ivory dark:placeholder:text-stone-500";
