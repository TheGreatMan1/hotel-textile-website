...
export default function BedHotspot({
  ...
  return (
    <motion.button
      ...
      className="absolute z-10 flex -translate-x-1/2 -translate-y-1/2 items-center gap-1.5 rounded-full border border-white/75 bg-ink/88 py-1 pl-1 pr-2.5 text-[10px] font-bold text-ivory shadow-[0_10px_24px_rgba(17,16,15,0.28)] outline-none backdrop-blur transition hover:bg-brass focus:ring-2 focus:ring-champagne focus:ring-offset-2 focus:ring-offset-white dark:bg-ivory/90 dark:text-ink dark:hover:bg-champagne dark:focus:ring-offset-ink"
