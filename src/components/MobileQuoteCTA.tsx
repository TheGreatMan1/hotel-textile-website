...
export default function MobileQuoteCTA({
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-40 border-t border-stone-200 bg-white/95 p-3 shadow-[0_-8px_24px_rgba(0,0,0,0.08)] backdrop-blur md:hidden dark:border-stone-800 dark:bg-[#181818]/95">
